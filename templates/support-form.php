...
if( is_user_logged_in() ) : ?>
	...
	<section id="ip-create-request-form-wrapper">
		<form method="post" id="ip-create-request-form" class="ip-form" action="<?php get_permalink(); ?>">
			<label for="ip-form-title">Support Request Title:</label>
			<input id="ip-support-request-title" name="ip-form-title"  placeholder="Add a descriptive, but brief title" type="text">	
			<?php echo get_ip_form_section_select(); ?>
			<label for="ip-form-description">Support Request Description:</label>
